function results = DeepSTRCF_VOT_setting(seq, res_path, bSaveImage, parameters)
setup_paths();
...
cnn_params.output_layer = [14];                 % Which layers to use, here we find that the conv5 features bring more gains
...
params.temporal_regularization_factor = [8 8];  % The temporal regularization parameters
